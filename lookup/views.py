...
def home(request):
    import json
    import requests
    str = "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=DAB62B28-33FA-46B6-BA04-E1CB63EDDCCF"
    zipcode = '89129'
    if request.method == "POST":
        zipcode = request.POST['zipcode']
        str = "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=DAB62B28-33FA-46B6-BA04-E1CB63EDDCCF"
    
    api_request = requests.get(str)
    try:
